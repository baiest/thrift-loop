...
export function RegisterPage(): React.JSX.Element {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md flex-col lg:max-w-none lg:flex-row">
      <AuthHero
        headline="Join the circle."
        subtext="Buy pieces you'll actually wear, sell the ones you won't."
      />

      <div className="-mt-6 flex flex-1 flex-col rounded-t-3xl bg-surface px-6 pb-6 pt-8 lg:mt-0 lg:rounded-none lg:px-16 lg:py-12">
        <div className="lg:mx-auto lg:w-full lg:max-w-sm">
          ...
          <p className="mb-6 text-sm text-ink-soft">
            Buy and sell second-hand clothing in Colombia.
          </p>
